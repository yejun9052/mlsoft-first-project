...
const TONE_CLASS = {
  muted: 'text-ink-mute hover:bg-white/[0.07] hover:text-ink-hi',
  danger: 'text-ink-mute hover:bg-danger/12 hover:text-danger',
  accent: 'text-ink-mute hover:bg-accent-cyan/12 hover:text-accent-cyan',
};
...
export default function IconButton({
  ...
  return (
    <button
      ...
      aria-label={label}
      disabled={disabled}
      className={`rounded-btn transition-colors disabled:cursor-not-allowed disabled:opacity-40 ${
